...
public class MonthlyProductionReport extends HttpSecureAppServlet {
  ...
  // .readXmlTemplate(
  // "com/ibox/paper/reportsd/gui/MonthlyProductionReport/MonthlyProductionReport_en")
  // .createXmlDocument();
  // else
  // xmlDocument = xmlEngine
  // .readXmlTemplate(
  // "com/ibox/paper/reportsd/gui/MonthlyProductionReport/MonthlyProductionReport_ar")
  // .createXmlDocument();
  //
  ...
  // "com.ibox.paper.reportsd.gui.MonthlyProductionReport.MonthlyProductionReport");
  //
  ...
  // if (vars.getLanguage().equals("en_US"))
  // xmlDocument = xmlEngine
  // .readXmlTemplate("com/ibox/paper/reportsd/gui/MonthlyProductionReport/finish_ar")
  // .createXmlDocument();
  // else
  // xmlDocument = xmlEngine
  // .readXmlTemplate("com/ibox/paper/reportsd/gui/MonthlyProductionReport/finish_ar")
  ...
  //
  // if (vars.getLanguage().equals("en_US"))
  // strReportName = "@basedesign@/com/ibox/paper/reportsd/files/Monthly_Production_Report.jrxml";
  // else
  // // /two/employeeperformance/employee_performance_en.jrxml
  // strReportName = "@basedesign@/com/ibox/paper/reportsd/files/Monthly_Production_Report.jrxml";
  //
  // MonthlyProductionReport_Entity[] entityArray =new
  // MonthlyProductionReport_Model().get_report_data(machineId, datefrom, dateto);
  //
  //
