...
package com.ibox.paper.dreportperday.gui.productperdayReport;
...
import com.ibox.paper.dreportperday.model.ProductPerDay_Model;

public class ProductPerDay extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/dreportperday/gui/productperdayReport/ProductPerDay_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/dreportperday/gui/productperdayReport/ProductPerDay_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ProductPerDay", false, "", "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.dreportperday.gui.productperdayReport.ProductPerDay");
      ...
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ProductPerDay.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/dreportperday/gui/productperdayReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/dreportperday/gui/productperdayReport/finish_ar")
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String proshiftid = request.getParameter("inpproshift");
    // String cutshiftid = request.getParameter("inpcutshift");
    String qdegreeid = request.getParameter("inpqdegree");

    String lang = vars.getLanguage();
    String strReportName = null;

    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/dreportperday/files/CustomerStatisticsReport_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/dreportperday/files/CustomerStatisticsReport.jrxml";

    ProductPerDay_Entity[] entityArray = new ProductPerDay_Model().get_report_data(proshiftid,
        qdegreeid);
    // cutshiftid,
