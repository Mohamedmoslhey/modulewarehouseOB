package com.ibox.paper.invevtorydeatilgGV.entity;

import java.math.BigDecimal;

import org.openbravo.data.FieldProvider;

public class InventoryDetailgGV_Entity implements FieldProvider {
  ...
  public String getBakarawidth() {
    return bakarawidth;
  }

  public void setBakarawidth(String bakarawidth) {
