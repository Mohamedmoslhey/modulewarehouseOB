package com.ibox.paper.invevtorydeatilgGV.model;
...
public class InventoryDetailgG_Model {
  ...
  public InventoryDetailgGV_Entity[] get_report_data(String invD, String invMachine,
      String inpDegree, String inpproducttype) {

    DateFormat formate = new SimpleDateFormat("dd-MM-yyyy");

    List<InventoryDetailgGV_Entity> entityList = new ArrayList<InventoryDetailgGV_Entity>();

    InventoryDetailgGV_Entity[] entityArray = null;
    Locator cuu = null;
    ...
    //
    InventoryDetailgGV_Entity entity = null;
    ...
    for (Object widthlisty : widthbject) {
      entity = new InventoryDetailgGV_Entity();
      ...
      //
      entity.setGsm(gsmobject.toString());
      entity.setBakarawidth(widoobject.toString());
    ...
    // to set bakraweigth
    /* if(StorageList) */
    entityArray = new InventoryDetailgGV_Entity[entityList.size()];
