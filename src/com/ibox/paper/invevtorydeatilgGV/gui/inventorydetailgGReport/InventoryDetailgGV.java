...
package com.ibox.paper.invevtorydeatilgGV.gui.inventorydetailgGReport;
...
import com.ibox.paper.invevtorydeatilgGV.entity.InventoryDetailgGV_Entity;
import com.ibox.paper.invevtorydeatilgGV.model.InventoryDetailgG_Model;

public class InventoryDetailgGV extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/invevtorydeatilgGV/gui/inventorydetailgGReport/InventoryDetailgGV_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "InventoryDetailgGV", false, "", "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.invevtorydeatilgGV.gui.inventorydetailgGReport.InventoryDetailgGV");

      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "invevtorydeatilgGV.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "InventoryDetailgGV.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/invevtorydeatilgGV/gui/inventorydetailgGReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate(
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.invevtorydeatilgGV.gui.invevtorydetailgGReport.InventoryDetailgGV");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "InventoryDetailgGV.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "InventoryDetailgGV.html",
          strReplaceWith);
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    InventoryDetailgGV_Entity[] entityArray = new InventoryDetailgG_Model().get_report_data(invD,
        invMachine, inpDegree, inpproducttype);
    if (entityArray != null) {
      if (vars.getLanguage().equals("en_US"))
        strReportName = "@basedesign@/com/ibox/paper/invevtorydeatilgGV/files/cross.jrxml";
      else
