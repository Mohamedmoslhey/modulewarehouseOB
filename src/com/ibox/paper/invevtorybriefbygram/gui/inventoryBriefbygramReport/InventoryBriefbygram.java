...
package com.ibox.paper.invevtorybriefbygram.gui.inventoryBriefbygramReport;
...
import com.ibox.paper.invevtorybriefbygram.model.InventoryBriefbygram_Model;

public class InventoryBriefbygram extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/invevtorybriefbygram/gui/inventoryBriefbygramReport/InventoryBriefbygram_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/invevtorybriefbygram/gui/inventoryBriefbygramReport/InventoryBriefbygram_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "InventoryBriefbygram", false, "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.invevtorybriefbygram.gui.inventoryBriefbygramReport.InventoryBriefbygram");

      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "invevtorybriefbygram.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "InventoryBriefbygram.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/invevtorybriefbygram/gui/inventoryBriefbygramReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate(
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "invevtorybriefbygram.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "invevtoryBriefbygram.html",
          strReplaceWith);
      xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/invevtorybriefbygram/files/InventoryBriefbygram_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/invevtorybriefbygram/files/InventoryBriefbygram_en.jrxml";

    InventoryBriefbygram_Entity[] entityArray = new InventoryBriefbygram_Model()
        .get_report_data(invD, inmachine, inpproducttype, inpdegree);
