...
package com.ibox.paper.invevtorydeatil.gui.inventorydetailReport;
...
import com.ibox.paper.invevtorydeatil.model.InventoryDetail_Model;

public class InventoryDetail extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/invevtorydeatil/gui/inventorydetailReport/InventoryDetail_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate(
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.invevtorydeatil.gui.inventorydetailReport.InventoryDetail");
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/invevtorydeatil/gui/inventorydetailReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/invevtorydeatil/gui/inventorydetailReport/finish_ar")
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.invevtorydeatil.gui.invevtorydetailReport.InventoryDetail");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/invevtorydeatil/files/InventoryDetail_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/invevtorydeatil/files/InventoryDetail_en.jrxml";

    InventoryDetail_Entity[] entityArray = new InventoryDetail_Model().get_report_data(invD);
