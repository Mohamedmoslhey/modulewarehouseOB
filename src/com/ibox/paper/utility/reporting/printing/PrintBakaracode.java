 ...
 * ***********************************************************************
 */
package com.ibox.paper.utility.reporting.printing;
...
public class PrintBakaracode extends PrintControllerM {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    // DocumentType documentType = DocumentType.BAKARAROLL;
    // The prefix PRINTSHIPMENTS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTBAKARACODE";
