...
package com.ibox.paper.productionperdaybrief.gui.ProductionPerDayBriefReport;
...
import com.ibox.paper.productionperdaybrief.model.ProductionPerDayBrief_Model;

public class ProductionPerDayBrief extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/productionperdaybrief/gui/ProductionPerDayBriefReport/ProductionPerDayBrief_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/productionperdaybrief/gui/ProductionPerDayBriefReport/ProductionPerDayBrief_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ProductionPerDayBrief", false, "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.productionperdaybrief.gui.ProductionPerDayBriefReport.ProductionPerDayBrief");

      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ProductionPerDayBrief.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ProductionPerDayBrief.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/productionperdaybrief/gui/ProductionPerDayBriefReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate(
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "ProductionPerDayBrief_ar.html", classInfo.id, classInfo.type, strReplaceWith,
          tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ProductionPerDayBrief_ar.html",
          strReplaceWith);
      xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String inpshift = request.getParameter("inpshift");

    String lang = vars.getLanguage();
    String strReportName = null;

    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/productionperdaybrief/files/ProductionPerDayBrief_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/productionperdaybrief/files/ProductionPerDayBrief_en.jrxml";

    ProductionPerDayBrief_Entity[] entityArray = new ProductionPerDayBrief_Model()
        .get_report_data(datefrom, dateto, inmachine, inpshift);
