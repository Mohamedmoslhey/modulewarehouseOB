package com.ibox.paper.salesreportbyrollnumber.model;
...
public class SalesReportRollnumber_Model {

  public SalesReportRollnumber_Entity[] get_report_data(String jumboCodeid) {
    // , String cutshiftid,
    DateFormat formate = new SimpleDateFormat("dd-MM-yyyy");

    List<SalesReportRollnumber_Entity> entityList = new ArrayList<SalesReportRollnumber_Entity>();
    SalesReportRollnumber_Entity[] entityArray = null;
    ...
    for (ShipmentInOutLine currenttransaction : materialtrxList) {
      ...
      SalesReportRollnumber_Entity entity = new SalesReportRollnumber_Entity();
    ...
    entityArray = new SalesReportRollnumber_Entity[entityList.size()];
