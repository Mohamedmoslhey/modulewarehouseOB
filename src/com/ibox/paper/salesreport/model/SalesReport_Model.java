package com.ibox.paper.salesreport.model;
...
public class SalesReport_Model {

  public SalesReport_Entity[] get_report_data(String partnerid, String datefrom, String dateto) {
    // , String cutshiftid,
    DateFormat formate = new SimpleDateFormat("dd-MM-yyyy");

    List<SalesReport_Entity> entityList = new ArrayList<SalesReport_Entity>();
    SalesReport_Entity[] entityArray = null;
    ...
    for (ShipmentInOut currenttransaction : materialtrxList) {
      ...
      for (ShipmentInOutLine cuLine : currenttransaction.getMaterialMgmtShipmentInOutLineList()) {
        ...
        SalesReport_Entity entity = new SalesReport_Entity();
    ...
    entityArray = new SalesReport_Entity[entityList.size()];
