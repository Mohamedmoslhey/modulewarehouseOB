...
package com.ibox.paper.salesreport.gui.salesReport;
...
import com.ibox.paper.salesreport.entity.SalesReport_Entity;
import com.ibox.paper.salesreport.model.SalesReport_Model;

public class SalesReport extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesreport/gui/salesReport/SalesReport_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesreport/gui/salesReport/SalesReport_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "SalesReport", false, "", "", "", false,
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.salesreport.gui.salesReport.SalesReport");
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesreport/gui/salesReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesreport/gui/salesReport/finish_ar")
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/salesreport/files/SalesDetailReport_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/salesreport/files/SalesDetailReport_en.jrxml";

    SalesReport_Entity[] entityArray = new SalesReport_Model().get_report_data(partnerid, datefrom,
        dateto);
    // cutshiftid,
