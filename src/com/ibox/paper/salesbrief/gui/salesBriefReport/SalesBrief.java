...
package com.ibox.paper.salesbrief.gui.salesBriefReport;
...
import com.ibox.paper.salesbrief.model.SalesBrief_Model;

public class SalesBrief extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbrief/gui/salesBriefReport/SalesBrief_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbrief/gui/salesBriefReport/SalesBrief_ar")
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "salesbriefbrief.html",
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/salesbrief/files/SalesBrief_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/salesbrief/files/SalesBrief_en.jrxml";

    SalesBrief_Entity[] entityArray = new SalesBrief_Model().get_report_data(inpDateFrom, inmachine,
        inpDateTo);
