...
package com.ibox.paper.dreportdeatilpermonth.gui.productperMonthReport;
...
import com.ibox.paper.dreportdeatilpermonth.model.ProductDeatilPerMonth_Model;

public class ProductDeatilPerMonth extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/dreportdeatilpermonth/gui/productperMonthReport/ProductDeatilPerMonth_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/dreportdeatilpermonth/gui/productperMonthReport/ProductDeatilPerMonth_ar")
    ...
    try {
      ...
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ProductDeatilPerMonth.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/dreportdeatilpermonth/gui/productperMonthReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate(
    ...
    try {
      ...
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ProductDeatilPerMonth.html",
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/dreportdeatilpermonth/files/ProductDeatilPerMonth_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/dreportdeatilpermonth/files/ProductDeatilPerMonth_en.jrxml";

    ProductDeatilPerMonth_Entity[] entityArray = new ProductDeatilPerMonth_Model()
        .get_report_data(datefrom, dateto);
