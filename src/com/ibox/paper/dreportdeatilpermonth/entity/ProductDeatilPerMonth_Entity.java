package com.ibox.paper.dreportdeatilpermonth.entity;

import java.math.BigDecimal;

import org.openbravo.data.FieldProvider;

public class ProductDeatilPerMonth_Entity implements FieldProvider {
  ...
  private BigDecimal width; // String qotr; //
  private BigDecimal wasn;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("maqsmasool")) {
      return maqsmasool;
    }

    else if (fieldName.equalsIgnoreCase("qualitymasool")) {
    ...
    if (fieldName.equalsIgnoreCase("average")) {
    ...
    if (fieldName.equalsIgnoreCase("waghcolor")) {
      return waghcolor;
    ...
    if (fieldName.equalsIgnoreCase("qualitydegree")) {
      return qualitydegree;

    }
    if (fieldName.equalsIgnoreCase("firstresonfars")) {
