...
package com.ibox.paper.salesbriefBp.gui.salesBriefBpReport;
...
import com.ibox.paper.salesbriefBp.model.SalesBriefBp_Model;

public class SalesBriefBp extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbriefBp/gui/salesBriefBPReport/SalesBriefBp_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbriefBp/gui/salesBriefBPReport/SalesBriefBp_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "InventoryBriefBp", false, "", "", "",
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "salesbriefbriefBp.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SalesBriefBp.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbriefBp/gui/salesBriefBpReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbriefBp/gui/salesBriefBpReport/finish_ar")
    ...
    try {
      ...
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "salesbriefBp.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "salesBriefBp.html",
          strReplaceWith);
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/salesbriefBp/files/SalesBrief_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/salesbriefBp/files/SalesBrief_en.jrxml";

    SalesBriefBp_Entity[] entityArray = new SalesBriefBp_Model().get_report_data(inpYears,
        inmachine, inpDateTo);
