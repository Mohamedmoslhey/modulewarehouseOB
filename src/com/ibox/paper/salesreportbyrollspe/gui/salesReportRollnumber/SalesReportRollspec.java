...
package com.ibox.paper.salesreportbyrollspe.gui.salesReportRollnumber;
...
import com.ibox.paper.salesreportbyrollspe.model.SalesReportRollspec_Model;

public class SalesReportRollspec extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    RollmanualData[] datrshow = RollmanualData.select(this);
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/salesreportbyrollnumber/gui/salesReportRollnumber/SalesReportRollnumber_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/salesreportbyrollnumber/gui/salesReportRollnumber/SalesReportRollnumber_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "salesReportRollnumber", false, "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.salesreportbyrollnumber.gui.salesReportRollnumber.SalesReportRollnumber");
      ...
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SalesReportRollnumber.html",
          strReplaceWith);
    ...
    xmlDocument.setData("structure1", datrshow);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/salesreportbyrollnumber/gui/salesReportRollnumber/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate(
    ...
    try {
      ...
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "salesReportRollnumber.html",
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String jumboCodeid = request.getParameter("inpjumboCode");
    // // String cutshiftid = request.getParameter("inpcutshift");
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/salesreportbyrollnumber/files/SalesDetailReportRollnumber_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/salesreportbyrollnumber/files/SalesDetailReportRollnumber_en.jrxml";

    SalesReportRollspec_Entity[] entityArray = new SalesReportRollspec_Model()
        .get_report_data(jumboCodeid);
    // cutshiftid,
