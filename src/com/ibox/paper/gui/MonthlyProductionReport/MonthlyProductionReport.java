...
package com.ibox.paper.gui.MonthlyProductionReport;
...
import com.ibox.paper.model.MonthlyProductionReport_Model;

public class MonthlyProductionReport extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/gui/MonthlyProductionReport/MonthlyProductionReport_en")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/gui/MonthlyProductionReport/MonthlyProductionReport_ar")
          .createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "MonthlyProductionReport", false, "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.gui.MonthlyProductionReport.MonthlyProductionReport");
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "MonthlyProductionReport.html", classInfo.id, classInfo.type, strReplaceWith,
          tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "MonthlyProductionReport.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/gui/MonthlyProductionReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/gui/MonthlyProductionReport/finish_ar")
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String machineId = request.getParameter("inpmachine");
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/files/Monthly_Production_Report.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/files/Monthly_Production_Report.jrxml";

    MonthlyProductionReport_Entity[] entityArray = new MonthlyProductionReport_Model()
        .get_report_data(machineId, datefrom, dateto);
