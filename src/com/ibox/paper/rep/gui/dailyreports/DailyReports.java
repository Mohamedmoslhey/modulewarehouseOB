...
package com.ibox.paper.rep.gui.dailyreports;
...
import com.ibox.paper.rep.entity.DailyReports_Entity;
import com.ibox.paper.rep.model.DailyReports_Model;

public class DailyReports extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate("com/ibox/paper/rep/gui/dailyreports/DailyReports_en")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("com/ibox/paper/rep/gui/dailyreports/DailyReports_ar")
          .createXmlDocument();
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.rep.gui.dailyreports.DailyReports");

      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "DailyReports.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "DailyReports.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    XmlDocument xmlDocument;
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate("com/ibox/paper/rep/gui/dailyreports/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("com/ibox/paper/rep/gui/dailyreports/finish_ar")
          .createXmlDocument();
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String shiftid = request.getParameter("inpPaperShift");

    String qualityDegreeid = request.getParameter("inpQualityDegree");

    String lang = vars.getLanguage();
    String strReportName = null;

    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/rep/files/Daily_Production_Report.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/opentus/inshape/clinic/files/Daily_Production_Report.jrxml";

    DailyReports_Entity[] entityArray = new DailyReports_Model().get_report_data(shiftid,
        qualityDegreeid);
