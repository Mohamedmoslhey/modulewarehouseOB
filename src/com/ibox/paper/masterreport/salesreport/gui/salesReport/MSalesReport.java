...
package com.ibox.paper.masterreport.salesreport.gui.salesReport;
...
import com.ibox.paper.masterreport.salesreport.model.MSalesReport_Model;

public class MSalesReport extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/masterreport/salesreport/gui/salesReport/SalesReport_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/masterreport/salesreport/gui/salesReport/SalesReport_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "MSalesReport", false, "", "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.masterreport.salesreport.gui.salesReport.SalesReport");
      ...
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SalesReport.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/masterreport/salesreport/gui/salesReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/masterreport/salesreport/gui/salesReport/finish_ar")
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.masterreport.salesreport.gui.salesReport.MSalesReport");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String partnerid = request.getParameter("inppartner");
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/masterreport/salesreport/files/SalesDetailReport_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/masterreport/salesreport/files/SalesDetailReport_en.jrxml";

    MSalesReport_Entity[] entityArray = new MSalesReport_Model().get_report_data(partnerid,
        datefrom, dateto);
    // cutshiftid,
