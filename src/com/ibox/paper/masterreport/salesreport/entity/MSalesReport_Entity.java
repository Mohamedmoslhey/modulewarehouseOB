package com.ibox.paper.masterreport.salesreport.entity;

import java.math.BigDecimal;

import org.openbravo.data.FieldProvider;

public class MSalesReport_Entity implements FieldProvider {
  ...
  public String toString() {
    return "MSalesReport_Entity [cpartner=" + cpartner + ", movementDate=" + movementDate
