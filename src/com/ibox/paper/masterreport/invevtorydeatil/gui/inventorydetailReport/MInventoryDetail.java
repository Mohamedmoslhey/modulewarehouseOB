...
package com.ibox.paper.masterreport.invevtorydeatil.gui.inventorydetailReport;
...
import com.ibox.paper.masterreport.invevtorydeatil.entity.MInventoryDetail_Entity;
import com.ibox.paper.masterreport.invevtorydeatil.model.MInventoryDetail_Model;

public class MInventoryDetail extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/masterreport/invevtorydeatil/gui/inventorydetailReport/InventoryDetail_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/masterreport/invevtorydeatil/gui/inventorydetailReport/InventoryDetail_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "InventoryDetail", false, "", "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.masterreport.invevtorydeatil.gui.inventorydetailReport.MInventoryDetail");

      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "invevtorydeatil.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "InventoryDetail.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/masterreport/invevtorydeatil/gui/inventorydetailReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate(
    ...
    try {
      ...
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "InventoryDetail.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "InventoryDetail.html",
          strReplaceWith);
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/masterreport/invevtorydeatil/files/MInventoryDetail_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/masterreport/invevtorydeatil/files/MInventoryDetail_en.jrxml";

    MInventoryDetail_Entity[] entityArray = new MInventoryDetail_Model().get_report_data(invD);
