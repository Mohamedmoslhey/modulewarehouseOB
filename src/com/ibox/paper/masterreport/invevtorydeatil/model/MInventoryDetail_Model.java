package com.ibox.paper.masterreport.invevtorydeatil.model;
...
public class MInventoryDetail_Model {

  public MInventoryDetail_Entity[] get_report_data(String invD) {

    DateFormat formate = new SimpleDateFormat("dd-MM-yyyy");

    List<MInventoryDetail_Entity> entityList = new ArrayList<MInventoryDetail_Entity>();

    MInventoryDetail_Entity[] entityArray = null;
    Locator cuu = null;
    ...
    MInventoryDetail_Entity entity = null;

    for (StorageDetail currentStorageDetail : StorageList) {
      entity = new MInventoryDetail_Entity();
      ...
      if (currentStorageDetail.getPAPERQualityDegree().getDegree().equals("2- درجة ثانيه")
        ...
        if (currentStorageDetail.getPaperSecondrefuse() == null) {
          entity.setFirstresonfars(currentStorageDetail.getPaperFirstrefuse().getReason());
          entity.setSecondresonfars(null);
        } else if (currentStorageDetail.getPaperFirstrefuse().getReason().equals(null)) {
          entity.setFirstresonfars(null);
    ...
    entityArray = new MInventoryDetail_Entity[entityList.size()];
