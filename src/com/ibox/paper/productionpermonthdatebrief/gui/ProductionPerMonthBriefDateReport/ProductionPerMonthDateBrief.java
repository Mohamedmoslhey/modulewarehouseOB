...
package com.ibox.paper.productionpermonthdatebrief.gui.ProductionPerMonthBriefDateReport;
...
import com.ibox.paper.productionpermonthdatebrief.model.ProductionPerMonthDateBrief_Model;

public class ProductionPerMonthDateBrief extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/productionpermonthdatebrief/gui/ProductionPerMonthBriefDateReport/ProductionPerMonthDateBrief_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/productionpermonthdatebrief/gui/ProductionPerMonthBriefDateReport/ProductionPerMonthDateBrief_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ProductionPerMonthDateBrief", false,
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.productionpermonthdatebrief.gui.ProductionPerMonthBriefDateReport.ProductionPerMonthDateBrief");
      ...
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
          "ProductionPerMonthDateBrief.html", strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/productionpermonthdatebrief/gui/ProductionPerMonthBriefDateReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/productionpermonthdatebrief/gui/ProductionPerMonthBriefDateReport/finish_ar")
    ...
    try {
      ...
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "ProductionPerMonthDateBrief_ar.html", classInfo.id, classInfo.type, strReplaceWith,
          tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(),
          "ProductionPerMonthDateBrief_ar.html", strReplaceWith);
      xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/productionpermonthdatebrief/files/ProductionPerMonthDateBrief_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/productionpermonthdatebrief/files/ProductionPerMonthDateBrief_en.jrxml";

    ProductionPerMonthDateBrief_Entity[] entityArray = new ProductionPerMonthDateBrief_Model()
        .get_report_data(datefrom, dateto, inmachine);
