...
public class CompleteProductionQuality extends DalBaseProcess {

  private static final Logger logger = Logger.getLogger(CompleteProductionQuality.class);
  ...
  OBError completeProductionquality(String QulaityId) {
    ...
    ProdQualit.setStatus("1");
    ProdQualit.setSosataus("1");
