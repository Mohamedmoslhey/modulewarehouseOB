...
package com.ibox.paper.salesOrderWithProductionMachine.gui.SalesProductionReport;
...
import com.ibox.paper.salesOrderWithProductionMachine.model.SalesProduction_Model;

public class SalesProduction extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/salesOrderWithProductionMachine/gui/SalesProductionReport/SalesProduction_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/ibox/paper/salesOrderWithProductionMachine/gui/SalesProductionReport/SalesProduction_ar")
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "SalesProduction", false, "", "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.salesOrderWithProductionMachine.gui.SalesProductionReport.SalesProduction");

      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "SalesProduction.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "SalesProduction.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbrief/gui/salesBriefReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/salesbrief/gui/salesBriefReport/finish_ar")
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.salesbrief.gui.salesBriefReport.SalesBrief");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "salesbrief.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "salesBrief.html",
          strReplaceWith);
      xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String inpDateFrom = request.getParameter("inpDateFrom");
    String inmachine = request.getParameter("inpmachine");
    String inpDateTo = request.getParameter("inpDateTo");

    String lang = vars.getLanguage();
    String strReportName = null;

    if (vars.getLanguage().equals("en_US"))
      strReportName = "@basedesign@/com/ibox/paper/salesOrderWithProductionMachine/files/SalesBrief_en.jrxml";
    else
      // /two/employeeperformance/employee_performance_en.jrxml
      strReportName = "@basedesign@/com/ibox/paper/salesOrderWithProductionMachine/files/SalesBrief_en.jrxml";

    SalesProduction_Entity[] entityArray = new SalesProduction_Model().get_report_data(inpDateFrom,
        inmachine, inpDateTo);
