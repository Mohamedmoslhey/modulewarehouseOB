...
package com.ibox.paper.invevtorydeatilgG.gui.inventorydetailgGReport;
...
import com.ibox.paper.invevtorydeatilgG.model.InventoryDetailgG_Model;

public class InventoryDetailgG extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "com/ibox/paper/invevtorydeatilgG/gui/inventorydetailgGReport/InventoryDetailgG_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "InventoryDetailgG", false, "", "", "",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.invevtorydeatilgG.gui.inventorydetailgGReport.InventoryDetailgG");

      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "invevtorydeatilgG.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "InventoryDetailgG.html",
          strReplaceWith);
  ...
  private void printFinishPage(HttpServletResponse response, HttpServletRequest request,
    ...
    if (vars.getLanguage().equals("en_US"))
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/invevtorydeatilgG/gui/inventorydetailgGReport/finish_ar")
          .createXmlDocument();
    else
      xmlDocument = xmlEngine
          .readXmlTemplate("com/ibox/paper/invevtorydeatilgG/gui/inventorydetailgGReport/finish_ar")
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.ibox.paper.invevtorydeatilgG.gui.invevtorydetailgGReport.InventoryDetailgG");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "InventoryDetailgG.html",
          classInfo.id, classInfo.type, strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "InventoryDetailgG.html",
          strReplaceWith);
  ...
  public void printReport(HttpServletResponse response, HttpServletRequest request,
    ...
    String invD = request.getParameter("inpwarhouse");
    String invMachine = request.getParameter("inpMachine");
    String inpDegree = request.getParameter("inpDegree");

    String inpproducttype = request.getParameter("inpproducttype");

    String lang = vars.getLanguage();
    String strReportName = null;
    InventoryDetailgG_Entity[] entityArray = new InventoryDetailgG_Model().get_report_data(invD,
        invMachine, inpDegree, inpproducttype);
    if (entityArray != null) {
      if (vars.getLanguage().equals("en_US"))
        strReportName = "@basedesign@/com/ibox/paper/invevtorydeatilgG/files/InventoryDetail_en.jrxml";
      else
      ...
      try {
        ...
        if (vars.getLanguage().equals("en_US"))
          xmlDocument = xmlEngine
              .readXmlTemplate(
                  "com/ibox/paper/invevtorydeatilgG/gui/inventorydetailgGReport/finish_ar")
              .createXmlDocument();
        else
          xmlDocument = xmlEngine
              .readXmlTemplate(
